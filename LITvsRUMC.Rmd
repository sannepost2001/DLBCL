...
EXCEL_location <- "//home//sanne//bioinf//afstuderen//DATA//RUMC//20062022_allmutdiagr1_together_3germlinefiltersapplied_voorsanne.xlsx"## Give the output location where the output files need to go. 
...
genesOrderd_all <- genenames_per_case_plot("", mysheets, 16)
plot(genesOrderd_all, 20)

# Get the genes of relapse and plot these
genesOrderd_rel <- genenames_per_case_plot("rel", mysheets, 16)
